...
def rnn_forward(x, h0, Wx, Wh, b):
  ...
  cache=[]
  for i in range(T):
  	h[:,i,:],cache_=rnn_step_forward(x[:,i,:],hidden,Wx,Wh,b)
  	hidden=h[:,i,:]
  	cache.append(cache_)
  ##############################################################################
  #                               END OF YOUR CODE                             #
...
def lstm_step_backward(dnext_h, dnext_c, cache):
  ...
  ai,af,ao,ag=a[:,0:H],a[:,H:2*H],a[:,2*H:3*H],a[:,3*H:]
  dnext_c_=dnext_h*o
  dnext_c+=dnext_c_*(1-(np.tanh(next_c))**2)
...
def lstm_forward(x, h0, Wx, Wh, b):
  ...
  cell=c0
  for i in range(T):
  	hidden,cell,cache_=lstm_step_forward(x[:,i,:],hidden,cell,Wx,Wh,b)
  	cache.append(cache_)
  	h[:,i,:]=hidden
  ##############################################################################
  #                               END OF YOUR CODE                             #
